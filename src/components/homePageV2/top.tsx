          ...
          <div className="container has-text-centered">
            ...
            <div className="columns is-centered">
              <div className="column is-6-desktop is-8-tablet home-description">
                <div className="is-h4">
                  Nua.ge est une offre cloud épurée de type IaaS, pensée pour
                  des utilisateurs exigeants et pragmatiques pour qui la
                  complexité n’est pas synonyme de performances.
                </div>
              </div>
            </div>
